...
void AttributeProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  switch (type_) {
    ...
    case AttributeType::FLOAT:
      return {common_helpers::MakeString(
          "{", name_.as_string(), ": ", has_f() ? common_helpers::MakeString(*f_) : "?", "}")};
    case AttributeType::INT:
      return {common_helpers::MakeString(
          "{", name_.as_string(), ": ", has_i() ? common_helpers::MakeString(*i_) : "?", "}")};
...
uint64_t SequenceProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, name)
  SIZE_ENUM_FIELD(size, options, stream, elem_type)
...
void SequenceProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, name)
  WRITE_ENUM_FIELD(options, stream, elem_type)
...
void SequenceProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options,
      NAME_EXIST_VALUE(name),
      NAME_EXIST_VALUE(elem_type),
      NAME_EXIST_VALUE(tensor_values),
      NAME_EXIST_VALUE(sparse_tensor_values),
      NAME_EXIST_VALUE(sequence_values),
      NAME_EXIST_VALUE(map_values),
...
void MapProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      options,
      NAME_EXIST_VALUE(name),
      NAME_EXIST_VALUE(key_type),
      NAME_EXIST_VALUE(keys),
      NAME_EXIST_VALUE(string_keys),
...
uint64_t OptionalProto::SerializeSize(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  uint64_t size = 0;
  SIZE_FIELD(size, options, stream, name)
  SIZE_ENUM_FIELD(size, options, stream, elem_type)
...
void OptionalProto::SerializeToStream(utils::BinaryWriteStream& stream, SerializeOptions& options) const {
  WRITE_FIELD(options, stream, name) //
  WRITE_ENUM_FIELD(options, stream, elem_type) //
...
void OptionalProto::ParseFromStream(utils::BinaryStream& stream, ParseOptions& options){
  ...
  return write_proto_into_vector_string(
      ...
      NAME_EXIST_VALUE(sequence_value),
      NAME_EXIST_VALUE(map_value),
